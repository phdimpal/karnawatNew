							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green util-btn-group">
									...
									<div class="portlet-body form">
										...
										<form id="cus_form" name="cus_form" action="customer_list" method="post" class="horizontal-form">
...
<div class="row">
	<div class="col-md-4">
		<div class="form-group">
			...
			<input type="text"  id="customer_gstin" name="customer_gstin" class="form-control" placeholder="Gst number">
		</div>
	</div>
<!--/span-->
...
<div class="row">
         ...
         <!---------------End Add Row Functionality Address------------>
						...
						<button type="submit" name="addcustomer" class="btn green"><i class="fa fa-check"></i> Save</button>
						</div>
						</form>
					</div>
				</div>
      ...
      function rename_row()
      {
        ...
        $('#main-tbody').find('tr').each(function()
        {
            ...
            $(this).find('.index').html(i);
						$(this).find('.person_name').attr('name','customer_addresses['+i+'][address]');
						$(this).find('#state_name_add').attr('name','customer_addresses['+i+'][state_id]').select2();
						$(this).find('#city_name_add').attr('name','customer_addresses['+i+'][city_id]').select2();
            $(this).find('.is_default').attr('name','customer_addresses['+i+'][is_default]');
...
<!--------------script END for add row Customer Address--------------->
<script>
