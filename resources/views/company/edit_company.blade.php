		...
		<div class="page-content">
			<div class="tab-content">
			  ...
			  <div class="portlet-body form">
									<!-- BEGIN FORM-->
				<form id="company_form" action="#" class="horizontal-form" enctype="multipart/form-data" runat="server">
					<div class="form-body">
					...
					<div class="row">
						...
						<div class="form-group">
							...
							<input type="number" name="company_name" id="company_name" class="form-control" placeholder="Name">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">City</label>
								  <select name="state_name" id="city_name" class="form-control">
                              ...
                              <table class="table table-striped table-bordered">
                                  <thead class="portlet box green util-btn-group">
                                      <tr >
                                          ...
                                          <th class="thColor tablescroll" style="width: 100px">Is Default</th>
					    ...
					    <div class="row">
					            ...
					            <table>
					              ...
					              <tbody id="sub-body_bank" class="hidden">
					                 <tr>
					                    <td style="vertical-align: bottom;" class="index_bank"> 
					                   ...
					                   <input class="index_bank" type="number" name="id_bank">
					                    ...
					                    <td style="vertical-align: bottom;"> <button type="button" id="plus_bank" class="btn btn-sm "><i class="fa fa-plus"></i></button>
					                      <button type="button" id="minus_bank" class="btn btn-sm "><i class="fa fa-minus"></i></button></td>
					                </tr>
					              </tbody>
					            </table>
					        </div>
